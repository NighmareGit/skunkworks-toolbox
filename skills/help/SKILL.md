...
1. If the question is about **current config** (what MCP servers, models, or settings are active),
   read `/home/hunter/.grok/config.toml`. MCP servers are under `[mcp_servers.*]` sections.
...
2. If the question is about **how to do something** (setup, adding MCP servers, creating skills,
   ...
   `/home/hunter/.grok/docs/user-guide/`. The available guides are:
   ...
   `/home/hunter/.grok/README.md` for the comprehensive reference.

3. To **modify config** for the user, edit `/home/hunter/.grok/config.toml` with search_replace.

4. To **create a skill** for the user, create `/home/hunter/.grok/skills/<name>/SKILL.md`
   (read `/home/hunter/.grok/docs/user-guide/08-skills.md` for the SKILL.md format).